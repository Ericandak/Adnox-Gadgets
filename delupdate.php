...
if ($id) {
    ...
    $bilname = $row['user_name'];
    $bilphone = $row['user_phone'];
    $bilemail = $row['user_email'];
    if (isset($_POST["update"])) {
        ...
        $state = $_POST["state"];
        $pin = $_POST["pin"];
        if ($house == null && $street == null && $city == null && $state == null && $pin == null) {
?>
            <script>
                alert("enter all values");
            </script>
            <script>
                location.href = "addaddress2.php"
            </script>
    <?php
        }
    }
        ...
        <script>
            $(document).ready(function() {
                ...
                $(".reg_uname").keyup(function() {
                    ...
                    if (r_uname == false) {
                        $("#rzp-button2").attr('disabled', true);
                ...
                function valid() {
                    if (r_uname == true && r_phone == true && r_email == true) {
                        ...
                        $("#rzp-button2").attr('disabled', false);
                    }
                }
            })
        </script>
                ...
                $('#rzp-button2').click(function() {
                    ...
                    var options = {
                        ...
                        "handler": function(response) {
                            ...
                            location.href = "deldata.php?tk=<?= $sum ?>&hou=<?=$house?>&str=<?=$street?>&cit=<?=$city?>&sta=<?=$state?>&pin=<?=$pin?>";      
                        },
                        "prefill": {
                            "name": "<?=$row['user_name'] ?>",
                        ...
                        <div class="row align-items-end">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="reg_uname" name="usr" class="form-control reg_uname" value="<?= $bilname ?> " disabled />
                                </div>
                            </div>
                            <div class="w-100"></div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="towncity">house</label>
                                    <input class="form-control" placeholder="" height="300" name="house" value="<?= $house ?>" disabled></input>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="towncity">street</label>
                                    <input class="form-control" placeholder="" height="300" name="street" value="<?= $street ?>" disabled></input>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="towncity">City</label>
                                    <input class="form-control" placeholder="" height="300" name="city" value="<?= $city ?>" disabled />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="towncity">State</label>
                                    <input class="form-control" placeholder="" height="300" name="state" value="<?= $state ?>" disabled />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="towncity">Pin</label>
                                    <input class="form-control" placeholder="" height="300" name="pin" value="<?= $pin ?>" disabled />
                                </div>
                            </div>
                            <div class="w-100"></div>
                            <div class="col-md-6">
                        ...
                        <div class="row mt-5 pt-3 d-flex">
                            ...
                            <div class="col-md-6">
                                <div class="cart-detail p-3 p-md-4">
                                    ...
                                    <p><input type="submit" class="btn btn-primary py-3 px-4" id="rzp-button2" value="Place an order"></p>
                                </div>
                            </div>
                        </div>
                    </div> <!-- .col-md-8 -->
