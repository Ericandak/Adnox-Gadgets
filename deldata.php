...
$result2 = mysqli_query($con, $query2);
  if ($result2) {
    ...
    $query = "INSERT INTO `tbl_delivery`(`billing_name`, `del_phone`, `del_mail`, `del_house`, `del_street`, `del_city`, `del_state`, `del_pin`, `user_id`, `order_id`) VALUES ('$bilname','$bilphone','$bilemail','$house','$street','$city','$state','$pin','$i','$oid')";
