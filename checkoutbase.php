			...
			$('#rzp-button1').click(function() {
				...
				var options = {
					...
					"handler": function(response) {
						...
						location.href = "deldata1.php?tk=<?=$sm?>";d
					},
					"prefill": {
						"name": "<?= $row['user_name'] ?>",
					...
					<div class="row align-items-end">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input class="form-control" placeholder="" height="300" name="house"  value="<?=$rq['House']?>" disabled></input>
							</div>
						</div>
                        <div class="col-md-6">
							<div class="form-group">
								<label for="towncity">street</label>
								<input class="form-control" placeholder="" height="300" name="street"  value="<?=$rq['street']?>" disabled></input>
							</div>
						</div>
                        <div class="col-md-6">
							<div class="form-group">
								<label for="towncity">City</label>
								<input class="form-control" placeholder="" height="300" name="city" value="<?=$rq['city']?>" disabled />
							</div>
						</div>
                        <div class="col-md-6">
							<div class="form-group">
								<label for="towncity">State</label>
								<input class="form-control" placeholder="" height="300" name="state" value="<?=$rq['state']?>" disabled/>
							</div>
						</div>
                        <div class="col-md-6">
							<div class="form-group">
								<label for="towncity">Pin</label>
								<input class="form-control" placeholder="" height="300" name="pin" value="<?=$rq['Pin']?>" disabled/>
							</div>
						</div>
						<div class="w-100"></div>
						<div class="col-md-6">
