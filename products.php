  ...
  <nav class="navbar navbar-expand-xl">
    <div class="container h-100">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link d-block" href="index1.php">
              <b>Logout</b>
            </a>
          </li>
        </ul>
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <form action="q.php" class="tm-edit-product-form" method="post" enctype="multipart/form-data">
              <div class="row tm-edit-product-row">
                <div class="col-xl-6 col-lg-6 col-md-12">
                  ...
                  <div class="col-10">
                    <input type="submit" class="btn btn-primary btn-block text-uppercase" name="catsub" value="add" id="submit" />
                  </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                  ...
                  <div class="custom-file mt-3 mb-3">
                    ...
                    <label class="text-white" for="file">Upload Category Image
                    </label>
                  </div>
                </div>
